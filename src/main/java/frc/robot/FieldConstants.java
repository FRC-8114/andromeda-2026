...
public class FieldConstants {
  ...
  public static final AprilTagFieldLayout fieldLayout = defaultAprilTagType.getLayout();
  ...
  public static class LinesVertical {
    ...
    public static final double oppAllianceZone =
        fieldLayout.getTagPose(10).get().getX();
  }
  ...
  public static class Hub {
    ...
    public static final Translation3d topCenterPoint =
        new Translation3d(
            fieldLayout.getTagPose(26).get().getX() + width / 2.0,
            fieldWidth / 2.0,
            height);
  ...
  public static class Tower {
    ...
    public static final Translation2d centerPoint =
        new Translation2d(
            frontFaceX, fieldLayout.getTagPose(31).get().getY());
