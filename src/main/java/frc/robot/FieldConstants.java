...
public class FieldConstants {
    ...
    public static final int aprilTagCount = defaultAprilTagType.getLayout().getTags().size();
    public static final double aprilTagWidth = Units.inchesToMeters(6.5);

    // Field dimensions
    public static final double fieldLength = defaultAprilTagType.getLayout().getFieldLength();
    ...
    public static class LinesVertical {
        ...
        public static final double starting = defaultAprilTagType.getLayout().getTagPose(26).get().getX();
        public static final double allianceZone = starting;
        public static final double hubCenter = defaultAprilTagType.getLayout().getTagPose(26).get().getX()
                + Hub.width / 2.0;
        ...
        public static final double oppHubCenter = defaultAprilTagType.getLayout().getTagPose(4).get().getX()
                + Hub.width / 2.0;
        public static final double oppAllianceZone = defaultAprilTagType.getLayout().getTagPose(10).get()
                .getX();
    }
    ...
    public static class Hub {
        ...
        // Hub faces
        public static final Pose2d nearFace = defaultAprilTagType.getLayout().getTagPose(26).get().toPose2d();
        public static final Pose2d farFace = defaultAprilTagType.getLayout().getTagPose(20).get().toPose2d();
        public static final Pose2d rightFace = defaultAprilTagType.getLayout().getTagPose(18).get().toPose2d();
        public static final Pose2d leftFace = defaultAprilTagType.getLayout().getTagPose(21).get().toPose2d();
    }
    ...
    public static class Outpost {
        ...
        public static final Translation2d centerPoint = new Translation2d(0,
                defaultAprilTagType.getLayout().getTagPose(29).get().getY());
    }
        ...
        public AprilTagFieldLayout getLayout() {
            if (layout == null) {
                synchronized (this) {
                    if (layout == null) {
                        try {
                            // Automatically resolve path based on whether we are on a robot or in
                            // simulation
