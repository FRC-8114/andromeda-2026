...
public class HubShiftUtil {
    ...
    public static boolean isAllianceFlipImminent(double warningThresholdSeconds) {
        ShiftInfo shiftInfo = getOfficialShiftInfo();
        
        return shiftInfo.currentShift() != ShiftEnum.AUTO
                && shiftInfo.currentShift() != ShiftEnum.DISABLED
                && shiftInfo.currentShift() != ShiftEnum.ENDGAME
                && shiftInfo.remainingTime() > 0.0
                && shiftInfo.remainingTime() <= warningThresholdSeconds;
    }
